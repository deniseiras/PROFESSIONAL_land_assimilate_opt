...
#BSUB -P R000                              # Project name
#BSUB -J "assm"             # Job name                     
#BSUB -W 00:20                             # Tempo máximo de execução (20 minutos)
#BSUB -o ttt.log                        # Single output file for all jobs
#BSUB -e ttt.log                        # Single output file for all jobs
#BSUB -n 1                  # Request cores (total processes)
#BSUB -q p_short                           # queue name (default s_short)
#BSUB -app spreads_filter                  # service class
